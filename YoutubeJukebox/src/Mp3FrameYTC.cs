...
// Original Author of this class is Mark Heath, NAudio: https://github.com/naudio/NAudio
// Changed to surpress end of stream exception, and to revert read position when loading frames from incomplete stream
...
namespace YoutubeJukebox
{
    ...
    public class Mp3FrameYTC
    {
        ...
        public static Mp3FrameYTC LoadFromStream(Stream input)
        {
        ...
        /// </remarks>
        /// <returns>A valid MP3 frame, or null if none found</returns>
        public static Mp3FrameYTC LoadFromStream(Stream input, bool readData)
        {
            long originalPos = input.Position;
            var frame = new Mp3FrameYTC();
            ...
            if (readData)
            {
                ...
                if (bytesRead < bytesRequired)
                {
                    ...
                    //Console.WriteLine("Incomplete frame");
                    input.Position = originalPos;
                    return null;
                }
            }
        ...
        /// </summary>
        private static bool IsValidHeader(byte[] headerBytes, Mp3FrameYTC frame)
        {
