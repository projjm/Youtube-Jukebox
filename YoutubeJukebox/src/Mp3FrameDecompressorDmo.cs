...
// Changed to use Mp3FrameYTC rather than original Mp3Frame objects
...
namespace YoutubeJukebox
{
    ...
    /// </summary>
    public class Mp3FrameDecompressorDmo : IDisposable
    {
        ...
        public Mp3FrameDecompressorDmo(WaveFormat sourceFormat)
        {
        ...
        /// </summary>
        public int DecompressFrame(Mp3FrameYTC frame, byte[] dest, int destOffset)
        {
